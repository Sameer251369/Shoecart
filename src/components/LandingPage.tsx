...
export const LandingPage = ({ onShopNow }: LandingPageProps) => {
  ...
  return (
    <section className="relative min-h-screen bg-white text-black flex flex-col overflow-hidden pt-28 lg:pt-32">
      <div className="flex-1 w-full grid grid-cols-1 lg:grid-cols-12 items-stretch">
        ...
        <motion.div
          ...
          className="z-10 px-8 md:px-20 lg:col-span-5 order-2 lg:order-1 flex flex-col justify-center py-12 lg:py-0"
        >
          <div className="max-w-md lg:max-w-lg">
            ...
            <h1 className="text-[clamp(3rem,7vw,5.5rem)] font-light leading-[1] tracking-tighter uppercase mb-8 text-zinc-900">
              Peak <br />
              <span className="font-serif italic text-zinc-400">Motion</span> <br />
              Studio
            </h1>

            <p className="text-zinc-500 text-xs md:text-sm max-w-xs md:max-w-sm leading-relaxed mb-10 font-medium uppercase tracking-[0.15em]">
        ...
        {/* Hero Image Slider */}
        <div className="relative w-full lg:col-span-7 order-1 lg:order-2 h-[60vh] lg:h-screen">
              ...
              >
                <span
                  className={`text-[10px] font-bold transition-opacity duration-500 ${
                    idx === currentImage ? 'opacity-100 text-white' : 'opacity-0 text-white/50'
                  }`}
                >
                  0{idx + 1}
                </span>
                <div
                  className={`w-[2px] transition-all duration-700 ${
                    idx === currentImage ? 'h-10 bg-white' : 'h-4 bg-white/30 group-hover:bg-white/60'
                  }`}
                />
              </button>
            ))}
